...
let mainHTMLElements = [
    [
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,9)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        ...
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,10)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,11)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,12)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        ...
        <button id="btn-red" class="main-container-frame-btn" onclick="moveMisterX(2,13)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,14)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        ...
        <button id="btn-orange" class="main-container-frame-btn" onclick="moveMisterX(3,15)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,16)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,17)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,18)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,19)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,20)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,21)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,22)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X va devoir révéler sa position à ce tour !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-red" class="main-container-frame-btn" onclick="moveMisterX(2,23)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,24)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X a révélé sa position au dernier tour, son prochain déplacement sera mystère !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-orange" class="main-container-frame-btn" onclick="moveMisterX(3,25)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,26)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,27)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,28)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,29)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,30)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,31)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,32)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X va devoir révéler sa position à ce tour !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-red" class="main-container-frame-btn" onclick="moveMisterX(2,33)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,34)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X a révélé sa position au dernier tour, son prochain déplacement sera mystère !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-orange" class="main-container-frame-btn" onclick="moveMisterX(3,35)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(136)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,37)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,38)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,39)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,40)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,41)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,42)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X va devoir révéler sa position à ce tour !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-red" class="main-container-frame-btn" onclick="moveMisterX(2,43)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,44)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X a révélé sa position au dernier tour, son prochain déplacement sera mystère !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-orange" class="main-container-frame-btn" onclick="moveMisterX(3,45)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,46)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,47)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,48)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,49)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,50)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Mister X se déplace !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-indigo" class="main-container-frame-btn" onclick="moveMisterX(1,51)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,52)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X va devoir révéler sa position à ce tour !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
        ...
        <button id="btn-red" class="main-container-frame-btn" onclick="moveMisterX(2,53)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>Les Équipes se déplacent !<br>Sélectionnez le numéro de la station vers chaque équipe se rend (laissez un vide pour les équipes ne jouant pas):<br>Équipe 1:</p>
        <input type="number" class="main-container-frame-input" id="team1LocationSelect" min="1" max="116">
        ...
        <p>Équipe 4:</p>
        <input type="number" class="main-container-frame-input" id="team4LocationSelect" min="1" max="116"><br>
        <button id="btn-mint" class="main-container-frame-btn" onclick="moveTeams(1,54)">Valider</button>
        </div>`,
        `<div class="main-container-frame-div">
        <p>⚠️ Mister X a révélé sa position au dernier tour, son prochain déplacement sera mystère !<br>Sélectionnez le numéro de la station vers laquelle il se rend:</p>
        <input type="number" class="main-container-frame-input" id="misterXLocationSelect" min="1" max="116">
